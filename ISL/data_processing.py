...
datadir = '/kaggle/input/isl-augmented-4200/Data_ISL'
...
for dir_ in os.listdir(datadir):
    ...
    # Print the letter (directory name) after processing all images in that directory
    print(f"Processed letter: {dir_}")

# Close the MediaPipe hands object
hands.close()

# Save the data using a context manager
with open('data_ISL.pickle', 'wb') as f:
